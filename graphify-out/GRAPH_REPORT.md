# Graph Report - Calendar-GInny-House  (2026-08-16)

## Corpus Check
- 241 files · ~162,587 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1373 nodes · 3228 edges · 150 communities (99 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a4ca8d0c`
...
## Communities (150 total, 51 thin omitted)

### Community 0 - "lib/push.ts"
Cohesion: 0.16
Nodes (16): unsubscribeFromPushAction(), GET(), LateCheckinRow, StaleCheckoutRow, getGroupPermissions(), configured, isPushOversightRole(), LEAVE_APPROVER_CANDIDATE_ROLES (+8 more)

### Community 1 - "cn"
Cohesion: 0.11
Nodes (26): BRANCHES, Chip(), DAY_MOMENTS, HeroBoard(), LandingPage(), metadata, BrandMark(), noopSubscribe() (+18 more)
...
Cohesion: 0.17
Nodes (13): MobileDayStrip(), VIEW_LABELS, WEEKDAY_LABELS, AppHeader(), AppLauncher(), APPS, formatter, RealtimeClock() (+5 more)

### Community 5 - "ShiftFormDialog.tsx"
Cohesion: 0.24
Nodes (16): formSchema, FormValues, ShiftRequestDialog(), DatePickerField(), DialogTrigger(), Label(), Select(), SelectContent() (+8 more)
...
Cohesion: 0.18
Nodes (12): MiniMonth(), WEEKDAY_LABELS, MultiSelectBranches(), Popover(), PopoverContent(), PopoverDescription(), PopoverHeader(), PopoverTitle() (+4 more)
...
Cohesion: 0.12
Nodes (19): signOutAction(), subscribeToPushAction(), NotificationsBell(), PushNotificationToggle(), UserMenu(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent() (+11 more)
...
Cohesion: 0.12
Nodes (38): ISSUE_ICON, formatRange(), formatTimeOfDay(), formatTypeDetail(), LeaveRequestCard(), TYPE_ICON, normalizeForSearch(), ShiftsOverviewTable() (+30 more)

### Community 16 - "ShiftCalendar.tsx"
Cohesion: 0.08
Nodes (43): CalendarDayHeader(), WEEKDAY_LABEL, CalendarToolbar(), VIEW_LABELS, maxTime, minTime, ShiftCalendar(), LEAVE_ICON (+35 more)
...
Cohesion: 0.11
Nodes (21): LeavePage(), AttendanceDetailDialog(), formatMinutes(), LeaveRequestDialog(), CALENDAR_COLLABORATOR_ONLY, CALENDAR_MANAGEMENT_ROLES, CALENDAR_OPERATIONS_ONLY, CALENDAR_STUDENT_AFFAIRS_ONLY (+13 more)
...
Cohesion: 0.24
Nodes (14): assertAssigneeAllowed(), createShiftAction(), deleteShiftAction(), mapShiftError(), updateShiftAction(), deactivateStaffAction(), mapStaffSecondaryRoleError(), updateStaffBranchesAction() (+6 more)
...
Cohesion: 0.18
Nodes (17): CreateAttendanceManualDialog(), GroupPermissionsEditor(), ManagerHolders, ROLE_PIE_COLORS, TechnicalDashboard(), aggregateStaffByRole(), GROUP_MANAGER_ROLES, GROUP_PERMISSION_LABELS (+9 more)
...
### Community 116 - "ClockWidget.tsx"
Cohesion: 0.14
Nodes (17): RegisterPage(), AttendanceCorrectionCard(), AttendanceHistory(), formatDuration(), ClockInGate, ClockWidget(), formatDuration(), getClockInGate() (+9 more)

### Community 117 - "SwapRequestDialog.tsx"
Cohesion: 0.17
Nodes (20): ColorPickerDialog(), CustomEventFormDialog(), endDateTouched(), formatRange(), formatTimeOfDay(), LeaveDetailDialog(), TYPE_ICON, formatRange() (+12 more)

### Community 119 - "StaffOverviewTable.tsx"
Cohesion: 0.09
Nodes (39): CollapsibleGrid(), PERIOD_LABELS, BandStat(), ManagerDashboard(), QueueRow(), normalizeForSearch(), RequestsOverviewTable(), formatMinutes() (+31 more)
...
### Community 121 - "createClient"
Cohesion: 0.12
Nodes (37): isValidColor(), updateBranchColorAction(), VALID_COLORS, followGroupAction(), followPersonAction(), isValidColor(), unfollowGroupAction(), unfollowPersonAction() (+29 more)
...
### Community 127 - "LeaveRequestDialog.tsx"
Cohesion: 0.21
Nodes (9): AttendanceCorrectionForm(), canSubmitRow(), CorrectionRow, emptyRow(), TYPE_OPTIONS, Textarea(), LEAVE_REQUEST_TYPES, LeaveRequestInput (+1 more)
...
### Community 131 - "card.tsx"
Cohesion: 0.09
Nodes (22): mapSignUpError(), signInAction(), signUpAction(), AccountPage(), AccountForm(), LoginForm(), CardAction(), CardDescription() (+14 more)
...
### Community 137 - "CalendarSidebar.tsx"
Cohesion: 0.09
Nodes (24): AddOtherCalendarMenu(), BranchRow(), CalendarCheckItem(), CalendarMobileMenu(), CalendarSidebar(), CustomCalendarRow(), EventTypeToggles, GroupSection() (+16 more)

### Community 138 - "manager/page.tsx"
Cohesion: 0.17
Nodes (18): AppShellLayout(), ManagerPage(), ProfileRoleRef, DateRangeFilter(), ShiftOverviewRow, StaffTable(), ShiftFormDialog(), buildNotifications() (+10 more)
...
### Community 142 - "attendance-corrections.ts"
Cohesion: 0.18
...
Cohesion: 0.18
Nodes (17): ShiftCalendar, ShiftCalendarLoader(), AttendanceWithProfileRole, CalendarView, LeaveRequestWithRole, AttendanceCorrectionIssue, AttendanceCorrectionStatus, CustomCalendar (+9 more)
...
- **Why does `createClient()` connect `createClient` to `card.tsx`, `shift-requests.ts`, `requireManager`, `manager/page.tsx`, `UserMenu.tsx`, `attendance-corrections.ts`, `actions/leave.ts`, `index.ts`, `swaps.ts`, `ClockWidget.tsx`, `roles.ts`, `actions/attendance.ts`?**
